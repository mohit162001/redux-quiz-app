const QUESTIONS = [
  ...
  },
  {
    ...
    answers: [
      ...
      "Provides a virtual environment for testing",
      "Creates a visual representation of the DOM",
      "Enhances accessibility in web applications",
    ],
  },
  {
    id: "q9",
    ...
    answers: [
      "To execute code after the component is mounted",
